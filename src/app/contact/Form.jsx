...
const Form = () => {
    ...
    return (
        <>
            {alert &&
                <div className="mb-5 border-t-4 border-secondary rounded-b text-teal-900 px-4 py-3 shadow-md w-2/3 rounded-lg md:w-1/2 m-auto absolute top-32 md:top-0 z-[100] bg-other " role="alert">
